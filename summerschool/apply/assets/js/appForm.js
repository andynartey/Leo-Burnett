...
// SIG // 0hEKPHlUElwcfT1LoIISMTCCBGAwggNMoAMCAQICCi6r
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT8gFezCAe+
// SIG // +JNkDukNNn7ECFPCWzBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAagBzAGMAcgBpAHAAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAn
// SIG // htqoMGnnPSqAP5Y8JddegeLCGt8mYXvQnO2lLFEFTitE
// SIG // 8kyDtT7qT7m4zt0aTPl/MgEpMoq22GpHQ0V+JLoRSXBe
// SIG // OZHm/ZB3lA3p0xjHvxThlTWOsH3BaaLajjN1bhSY4vLh
// SIG // kG+bZtN9JwI7NGLQQSnYo8hXx/bukTdcB+jAyRq0o+fz
// SIG // TKa3IrQJadLjSiZIURpW5tOHB6fK1m109qhSPYQjLjVv
// SIG // 6XvfRuz40cUZBtE+Mp5lb3i1WEXFJFyu7RV18Eo9ESB4
// SIG // 20PhVlVfoo2W3gHaScWFnqIdHGnsBdlBDRS2uwzDConS
// SIG // sBlCXVRoTEgz1iA9kySihNw+2Gd1RSPKoYICHzCCAhsG
...
// SIG // BgkqhkiG9w0BCQUxDxcNMTAwMzIwMDIxMTM3WjAjBgkq
// SIG // hkiG9w0BCQQxFgQUfXcw5n3hRKCCBbvLDmJPO5rg1Qsw
// SIG // DQYJKoZIhvcNAQEFBQAEggEAeDuOjdzsOLLQmHhjSDwH
// SIG // dRAhjlmePNJB2yniItBcTEUuucsS2vSSBzYZ9h+QNmes
// SIG // lXOAkJpG+D4b6qtmmDkTl/IeciZBSipVfF25wRbnycCH
// SIG // NPjuNKqbmXiKNECeayKYiaiCpPWV2niob4jHn2Bw2Za1
// SIG // yk3vuYwxBO+0pNVsJOyv+B3MDn5CnvtDwDDxj6GUkcv1
// SIG // Y9NsuPGuGgfsUoYHsGGIFs3FEsjTwIetF8CQ39zvMeic
// SIG // OAc74o0xYkOJObUzIy6oI5koasYId8raPxVV2zKQME2f
// SIG // FYS954PzvSKOO/N/QawQ1uSipWHnya4nbPpHlq4pjjro
// SIG // CQufZiZaVGqMOw==
// SIG // End signature block

// Validating entries

//This is where we validate the form upon submission


$(document).ready(function () {

    $('.contactForm input[type=text], .contactForm textarea, .contactForm input[type=radio],').blur(function () {
        ...
        switch (elementName) {
            ...
            case 'PositionRadioList':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Which account are you applying for?";
                }
                break;
            ...
            case 'FirstNameTxtBox':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please tell us your Firstname";
                }
                break;
            case 'LastNameTextbox':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please tell us your Surname";
                }
                break;
            case 'AddressTxtBox1':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please tell us the first line of your address";
                }
                break;
            case 'CountyTxtBox':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please tell us your county";
                }
                break;
            case 'ContactNumberTxtBox':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please provide a contact number";
                }
                break;
            case 'EmailTxtBox':
                if (-1 == elementValue.indexOf('@') || '' == elementValue) {
                    results.valid = false;
                    results.msg = "Please provide a valid email address";
                }
                break;
            case 'QuestionTxtBox1':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please answer this question";
                }
                break;
            case 'QuestionTxtBox2':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please tell us more";
                }
                break;
			case 'QuestionTxtBox3':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please tell us more";
                }
            ...
            case 'PostcodeTxtBox':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please enter your postcode";
                }
                break;
            case 'CountryTxtBox':
                if ('' == elementValue) {
                    results.valid = false;
                    results.msg = "Please enter your country name";
                }
                break;   
